    ...
    <div class="container my-5">
        <div class="row no-gutters">
            <div class="col-md-5 d-flex flex-column align-items-center justify-content-center text-center text-white p-4" style="background-color:#c370ead6">
                <div class="logo mb-3">
                    <img src="{{asset('images/green_check.png')}}" alt="Romanchat" class="img-fluid rounded-circle" style="width: 80px; height: 80px;">
                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="project_type[]" value="2">
                            <label class="form-check-label">Site Investigation</label>
                        </div>
                         <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="project_type[]" value="3">
                            <label class="form-check-label">Digital Address Verification</label>
                        </div>
                    </div>
                    <div class="form-group">
